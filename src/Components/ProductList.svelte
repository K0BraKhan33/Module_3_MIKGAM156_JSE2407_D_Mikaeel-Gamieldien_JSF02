...
<script>
  ...
  // Define writable stores for items, filtered items, sorting, and categories
  ...
  // Function to initialize sorting and filtering from URL parameters
...
<div class="bg-green-800 min-h-screen p-4">
    ...
    <div class="bg-green-300 flex space-x-4">
        <div>
